...
Partial Class Secured_SystemAdministration_adUserChangePassword : Inherits System.Web.UI.Page
    ...
    Protected Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If thisMsgBox.getModalType = "SAVE" Then
            saveRecord()
            thisMsgBox.setModalType("CHANGE OK")
            thisMsgBox.setInfo("CHANGE SUCCESSFUL", "Successfully Changed Password!")
            thisMsgBox.showConfirmBox()
        ElseIf thisMsgBox.getModalType = "CANCEL" Then
            Response.Redirect("~/Secured/Default.aspx")
        ElseIf thisMsgBox.getModalType = "CHANGE OK" Then
            Response.Redirect("~/Secured/Default.aspx")
        Else
            'Response.Redirect("adUserChangePassword.aspx")
        End If
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If strMessage = "" Then
            ...
            thisMsgBox.setHeaderText("CHANGE PASSWORD")
            thisMsgBox.setMessage("Change User Password ?")
        Else
            thisMsgBox.setInfo("INVALID", strMessage)
        End If
        thisMsgBox.showConfirmBox()
    ...
    Protected Sub btnCancel_Click(sender As Object, e As EventArgs) Handles btnCancel.Click
        ...
        thisMsgBox.setHeaderText("PASSWORD")
        thisMsgBox.setMessage("CANCEL CHANGE PASSWORD?")
        thisMsgBox.showConfirmBox()
