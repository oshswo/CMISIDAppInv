<%@ Page Language="VB" AutoEventWireup="false" CodeFile="adminUserEntry.aspx.vb" Inherits="Secured_UserAdmin_adminUserEntry" Theme="Skins"%>
        ...
        <div class="container" style="width: 100%">
            <div class="panel panel-success">
                <div class="panel-heading" style="text-align: center">
                    <asp:Label runat="server" ID="Label1" Text="User Entry" Style="font-size:25px;font-weight:bold;"></asp:Label>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <asp:GridView runat="server" ID="_gv" HeaderStyle-Font-Size="11px" CssClass="gridviewYellow" PageSize="10"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="user_id" HeaderText="User ID" ItemStyle-Width="40%" />

                            <asp:BoundField DataField="user_name" HeaderText="User Name" ItemStyle-Width="40%" />
                            <asp:BoundField DataField="is_active" HeaderText="Is Active" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" />
                        </Columns>
                    </asp:GridView>
                    <br />
                    <asp:Button runat="server" ID="btnAdd" CssClass="btn btn-primary btn-lg pull-right" Text="Add" />&nbsp;&nbsp;
