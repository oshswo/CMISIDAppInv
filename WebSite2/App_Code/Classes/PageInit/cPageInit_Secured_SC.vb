...
Public Class cPageInit_Secured_PWD
    ...
    Protected Sub GetUserPermission()
        ...
        Dim _wuc As UserControl = cph.FindControl("confirmBox")


        If Session("isSuperAdmin") = "Y" Then
            If Not IsNothing(_btnAdd) Then
                _btnAdd.Visible = True
            End If

            'Add/Edit
            If Session("PWD_AE_STATUS") = "ADD" Then
                If Not IsNothing(_wuc) Then _wuc.Visible = True
                If Not IsNothing(_btnSave) Then
                    ...
                    End If
                End If
            ElseIf Session("PWD_AE_STATUS") = "EDIT" Then
                If Not IsNothing(_wuc) Then _wuc.Visible = True
                If Not IsNothing(_btnSave) Then
                    _btnSave.Visible = True
                    If Not IsNothing(_btnCancel) Then
        ...
        'Add/Edit
        If Session("PWD_AE_STATUS") = "ADD" Then
            If Not IsNothing(_wuc) Then _wuc.Visible = _bolControl(1)
            If Not IsNothing(_btnSave) Then
            ...
            End If
        ElseIf Session("PWD_AE_STATUS") = "EDIT" Then
            If Not IsNothing(_wuc) Then _wuc.Visible = _bolControl(2)
            If Not IsNothing(_btnSave) Then
